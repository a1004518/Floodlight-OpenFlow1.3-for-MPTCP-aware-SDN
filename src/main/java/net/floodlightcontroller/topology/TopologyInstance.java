...
public class TopologyInstance {
    ...
    protected Path getRoute(DatapathId srcId, OFPort srcPort,
        ...
        NodePortTuple npt;
        Path r = getRoute(srcId, dstId, U64.of(0));
    ...
    protected Path getRoute(DatapathId srcId, DatapathId dstId, U64 cookie) {
